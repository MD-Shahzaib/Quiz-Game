...
const Result = ({ score, questions, darkMode, handleRestartQuiz }) => {
    const performance = (score / questions.length * 100);
    return (
        <div className='container mx-auto p-4'>
            <div className={`${darkMode ? "bg-slate-800 text-gray-200" : "bg-gray-200 text-gray-800"} my-10 flex flex-col justify-center items-center`}>
